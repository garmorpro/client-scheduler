    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', async () => {
            ...
            try {
                ...
                let html = `
    <div class="align-content-center" style="background-color: rgb(245,245,247); border-radius: 15px; display: flex; align-items: center; gap: 10px; padding: 10px; margin-top: -20px;">
