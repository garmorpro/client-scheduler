    ...
    <?php foreach ($clients as $client): ?>
        <div class="client-card p-4 bg-card text-card-foreground flex flex-col gap-2 rounded-xl">
            ...
            <div class="card-buttons d-flex flex-wrap gap-2">
                <button class="badge text-black p-2 text-decoration-none fw-medium" style="font-size: .875rem; border: 1px solid rgb(229,229,229);"><i class="bi bi-eye"></i> View</button>
                <button class="badge text-white p-2 text-decoration-none fw-medium" style="font-size: .875rem; background-color: rgb(3,2,18);"><i class="bi bi-pencil"></i> Edit</button>
            </div>
        </div>
    <?php endforeach; ?>
