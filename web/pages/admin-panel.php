            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="text-muted">
                      ...
                      <span id="view_first_name_detail" class="d-inline-block text-end" style="min-width: 150px;"></span>
                    </p>
                    <p class="text-muted">
                        <strong>Last Name:</strong> 
                        <span id="view_last_name_detail" class="d-inline-block text-end" style="min-width: 150px;"></span>
                    </p>
                    <p class="text-muted">
                        <strong>Email:</strong> 
