    ...
    <div class="container-fluid">
        ...
        <!-- Tabs -->
          <div class="custom-tabs">
              ...
              <a href="#time_off" class=" text-decoration-none" data-tab="time_off">Company-wide PTO Management</a>
              ...
              <!-- individual pto -->
                <!-- <div id="individual_pto" class="nested-tab-content">
                    <div class="timeoff-header d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="timeoff-search mx-3" style="flex: 1; max-width: 600px;">
