            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p class="text-muted">
                      ...
                      <span id="view_first_name_detail" class="d-inline-block text-end" style="min-width: 60%; font-size: 14px;"></span>
                    </p>
                    <p class="text-muted">
                    ...
                    <p class="text-muted">
                        <strong>Email:</strong> 
                        <span id="view_email_detail" class="d-inline-block text-end" style="min-width: 75%; font-size: 14px !important;"></span>
                    </p>
                </div>
                <div class="col-md-6">
                    test
