...
<div class="flex-grow-1 p-4">
  ...
  <!-- Week Summary -->
  <div class="list-group-item d-flex justify-content-between align-items-center bg-light p-4">
    <div>
    ...
    <div class="fw-bold fs-4"><?php echo $netHours; ?>h <br><span class="text-muted fw-normal" style="font-size: 14px; padding-top: -15px !important;">Net Hours</span></div>
  </div>
