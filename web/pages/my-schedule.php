...
<div class="flex-grow-1 p-4">
  ...
  <!-- Week Summary -->
<div class="list-group-item d-flex justify-content-between shadow-sm align-items-center bg-light p-4" style="background-color: rgb(249,249,250); border-radius: 15px;">
