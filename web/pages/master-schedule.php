    ...
    <div class="modal-content">
      <form id="assignmentForm" action="add_assignment.php" method="POST">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" id="isTimeOff" name="is_timeoff" value="1">

          <!-- Custom Client Dropdown -->
          <div class="mb-3 custom-dropdown">
            <label for="engagementInput" class="form-label">Client Name (optional for Time Off)</label>
            <div
              class="dropdown-btn"
              id="dropdownBtn"
              tabindex="0"
            ...
            >
              <span id="selectedClient" class="text-muted">Select a client or leave blank for Time Off</span>
            ...
            <input type="hidden" id="engagementInput" name="engagement_id" value="">
          </div>

          <!-- Time Off Hours input (shown if no client selected) -->
          <div class="mb-3" id="timeOffHoursContainer">
            <label for="timeOffHours" class="form-label">Time Off Hours</label>
            <input type="number" class="form-control" id="timeOffHours" name="time_off_hours" min="0" step="0.25" required>
          </div>

          <!-- Assigned Hours input (shown if client selected) -->
          <div class="mb-3 d-none" id="assignedHoursContainer">
            <label for="assignedHours" class="form-label">Assigned Hours</label>
            <input type="number" class="form-control" id="assignedHours" name="assigned_hours" min="0" step="0.25">
          </div>
        </div>
