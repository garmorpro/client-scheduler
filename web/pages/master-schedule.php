...
// Calculate Mondays as timestamps (26 weeks)
            ...
            <thead class="table-light">
                <tr>
                    ...
                    <?php foreach ($mondays as $idx => $monday): ?>
                        ...
                        <th class="<?php echo $isCurrent ? 'highlight-today' : ''; ?>"><?php echo date('M j', $weekStart); ?><br><small class="text-muted">Week of <?php echo date('n/j', $weekStart); ?></small></th>
                    <?php endforeach; ?>
                </tr>
            </thead>
                            ...
                            if (!empty($entriesForWeek)) {
                                ...
                                foreach ($entriesForWeek as $entry) {
                                    if (empty($entry['is_timeoff']) || intval($entry['is_timeoff']) !== 1) {
                                        ...
                                        $entry_class = $engagementStatus === 'pending' ? 'badge-pending' : ($engagementStatus === 'not_confirmed' ? 'badge-not-confirmed' : 'badge-confirmed');
