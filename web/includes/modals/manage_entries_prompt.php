<div class="modal fade" id="manageEntryPromptModal" tabindex="-1">
  ...
  <button id="backToButtons" class="badge text-bg-secondary text-white p-2 text-decoration-none fw-medium mb-3" style="font-size: .875rem; background-color: rgb(3,2,18); border: none !important;">Back</button>
