                        ...
                        ${group.map(entry => `
                            <form class="entry-form mb-3" data-id="${entry.timeoff_id}">
                                <div class="row g-2 align-items-center">
                                    ...
                                    <div class="col-md-2 d-flex align-items-end align-items-center gap-1" style="margin-top: 28px;">
                                        <button type="submit" class="btn btn-sm save-btn-hover"><i class="bi bi-save"></i></button>
