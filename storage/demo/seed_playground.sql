...
-- ---------------------------------------------------------------------
INSERT INTO role_permissions (role, manage_employees, view_employees, manage_clients_engagements, view_clients_engagements, approve_time_off, view_time_off_requests, access_system_settings) VALUES
('manager',   1, 1, 1, 1, 1, 1, 0),
('senior',    0, 1, 0, 1, 0, 1, 0),
('staff',     0, 0, 0, 1, 0, 0, 0),
('intern',    0, 0, 0, 1, 0, 0, 0),
('crm_team',  0, 1, 1, 1, 0, 0, 0);
