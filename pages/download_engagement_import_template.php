...
$headers = ['client_name', 'engagement_name', 'year', 'status', 'budgeted_hours', 'manager', 'audit_types', 'tsc', 'soc_type', 'as_of_date', 'review_period_start', 'review_period_end', 'roc_delivery_date', 'location', 'poc', 'scope', 'repeat', 'notes'];
$sheet->fromArray($headers, null, 'A1');
styleHeaderRow($sheet, count($headers));
...
$sheet->getStyle('A2:R2')->getFont()->setItalic(true)->getColor()->setRGB('9AA39D');
...
addDropdown($sheet, 'Q', 2, 200, ['Yes', 'No']);
foreach (['J', 'K', 'L', 'M'] as $col) $sheet->getStyle("{$col}2:{$col}200")->getNumberFormat()->setFormatCode('yyyy-mm-dd');
foreach (['A' => 28, 'B' => 22, 'C' => 8, 'D' => 14, 'E' => 15, 'F' => 20, 'G' => 22, 'H' => 26, 'I' => 10, 'J' => 13, 'K' => 16, 'L' => 16, 'M' => 16, 'N' => 16, 'O' => 16, 'P' => 24, 'Q' => 9, 'R' => 24] as $col => $w) $sheet->getColumnDimension($col)->setWidth($w);
