    ...
    <div class="container-fluid">
        ...
        <!-- Tabs -->
          <div class="custom-tabs">
              <a href="#employees" class=" text-decoration-none" data-tab="employees">Employee Management</a>
              <a href="#activity" class=" text-decoration-none" data-tab="activity">System Activity</a>
              <a href="#settings" class=" text-decoration-none " data-tab="settings">Settings</a>
          </div>
        <!-- end Tabs -->
